...
Se sirve el **build compilado** (`firebase/public`) con `support/static-server.mjs`, no
...
del proyecto Angular es ese artefacto (`firebase/public`), producido por `ng build` antes de
