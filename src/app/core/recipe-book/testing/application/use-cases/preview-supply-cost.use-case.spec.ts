...
import { PreviewSupplyCost } from '../../../application/use-cases/preview-supply-cost.use-case';

describe('PreviewSupplyCost', () => {
  let preview: PreviewSupplyCost;

  beforeEach(() => {
    TestBed.configureTestingModule({});
    preview = TestBed.inject(PreviewSupplyCost);
  });
