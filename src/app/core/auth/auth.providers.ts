...
import { IndexedDbAuthSettingsRepository } from './infrastructure/indexeddb-auth-settings.repository';
 ...
 *
 * La sesión vive en memoria y solo los ajustes se persisten. Sin app-initializer: sin sesión no hay
 * nada que arrancar, y ese es el estado inicial de la app.
 */
export function provideAuth(): EnvironmentProviders {
  return makeEnvironmentProviders([
    { provide: Authenticator, useClass: GoogleAuthenticator },
    { provide: Session, useClass: InMemorySession },
    { provide: AuthSettingsRepository, useClass: IndexedDbAuthSettingsRepository },
