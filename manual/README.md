...
| Documento | Qué cubre |
|---|---|
| [`deploy/README.md`](../deploy/README.md) | **La carpeta que publica.** El mapa de `deploy/` (el único sitio del repo que conoce Firebase, y sin lógica de despliegue dentro), los **marcadores** que llevan los ficheros versionados y cómo los sustituye el pipeline, qué configura cada *environment* de GitHub, publicar paso a paso, y las tres cosas que parecen errores y no lo son. Incluye **los pasos para crear el Client ID y el client secret de Google**, el **único** sitio con ese procedimiento. |
