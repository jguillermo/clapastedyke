/**
 * Iconos SVG de línea, uno por flujo del manual (copiados de Manual_de_usuario.html)
 * y uno por nivel del juego. Se inyectan con [innerHTML].
...
/** Icono de cada nivel del juego. */
export const ICONOS_NIVEL: Record<string, string> = {
  basico:
